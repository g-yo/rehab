...
LOGIN_REDIRECT_URL = '/'
LOGOUT_REDIRECT_URL = '/'
LOGIN_URL = '/login/'  # Set the custom login URL to match our URL pattern
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'geoaugustion@gmail.com'
EMAIL_HOST_PASSWORD = 'batq vxgt vjlo droj'
DEFAULT_FROM_EMAIL = 'Rehab Center <geoaugustion@gmail.com>'